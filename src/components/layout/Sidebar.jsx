...
const navItems = [
  ...
  { to: '/dashboard#calendar', label: 'Demand Calendar' },
  { to: '/map', label: 'Nairobi Map' },
  { to: '/ask', label: 'Ask AI' },
...
export default function Sidebar() {
  ...
  return (
    ...
    >
      ...
      {property && (
        <div className="group mx-5 mb-8 p-3 rounded-lg border" style={{ borderColor: 'rgba(255,255,255,0.08)', background: 'rgba(255,255,255,0.05)' }}>
      ...
      <nav className="flex-1 px-0">
        ...
        {navItems.map((item) => (
          <NavLink
            ...
            className={({ isActive }) =>
              `block px-5 py-2 text-[13px] transition-colors duration-150 border-l-2 ${
                isActive
